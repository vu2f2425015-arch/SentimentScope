...
const TAB_THEMES = {
dark: {
dashboard:   { from: [168, 85, 247],  to: [99, 102, 241],   glow: [168, 85, 247] },
single:      { from: [6, 182, 212],   to: [99, 102, 241],   glow: [6, 182, 212] },
batch:       { from: [236, 72, 153],  to: [168, 85, 247],   glow: [236, 72, 153] },
performance: { from: [16, 185, 129],  to: [6, 182, 212],    glow: [16, 185, 129] },
reports:     { from: [245, 158, 11],  to: [168, 85, 247],   glow: [245, 158, 11] }
},
light: {
...
try {
window.currentActiveDataset = null;
